...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">GO Enrichment</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">GO Enrichment</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="draw_go2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3" style="margin-bottom: 20px;">
                <label style="margin-bottom: 16px;">3. Input threshold for GO enrichment analysis</label>  &nbsp;&nbsp;&nbsp; <br/>
                <label>pvalue (NOTE: The threshold range is [0, 1]) </label>  &nbsp;&nbsp;&nbsp;
                <input  type="text" name="pvalue" id="pvalue" value="0.05" class="form-control">
                <label>qvalue (NOTE: The threshold range is [0, 1]) </label>  &nbsp;&nbsp;&nbsp;
                <input type="text" name="qvalue" id="qvalue" value="0.05" class="form-control">
            ...
            <div class="pb-3" style="margin-bottom: 20px;">
                <label>5. Plot type</label>  &nbsp;&nbsp;&nbsp;
                <input type="radio" name="type" value="bubble" checked> Bubble &nbsp;
                <input type="radio" name="type" value="barplot"> Barplot &nbsp; 
            ...
            <div class="pb-3" id="termNum_div" style="margin-bottom: 20px;" >
                <label>6. Input the number of terms for each ontology to be displayed</label>  &nbsp;&nbsp;&nbsp;
