...
<script type="text/javascript">
    ...
    var download_example = function() {
        ...
        const fileUrl = "./example/train_example.zip"; // 文件的实际路径
        const fileName = "train_example.zip"; // 下载时保存的文件名
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Train your supervised model</span></h2>
...
<section id="service" class="padding-medium">
    ...
    <div class="container">
        ...
        <form id="form" class="train_form" name="train_form" method="post" action="modelTrain.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3">
                <label>(1) Epoch</label>
                <input type="text" name="epoch" id="epoch" value="20" class="form-control">
            </div>
            <div class="pb-3">
            ...
            <div class="pb-3">
                ...
                <input type="text" name="es" id="es" value="10" class="form-control">
            </div>
            <div class="pb-3">
