...
function renderOntologyTable($filePath, $fileName, $perPage = 15, $tableId = 1) {
    ob_start();
    ?>
    <!DOCTYPE html>
    <html>
...
<!--            <h2>Table --><?php //echo $tableId; ?><!--: --><?php //echo htmlspecialchars($filePath); ?><!--</h2>-->
            ...
            <div class="filters">
                ...
                <div class="filter-group">
                    <label>Count:</label>
                    <input type="number" id="min_Count-<?php echo $tableId; ?>" placeholder="Min">
                    <input type="number" id="max_Count-<?php echo $tableId; ?>" placeholder="Max">
                </div>
            ...
            function renderDataTable(filePath, perPage, tableId) {
                ...
                function getFilters() {
                    return {
                        ...
                        min_Count: document.getElementById(`min_Count-${tableId}`).value || '',
                        max_Count: document.getElementById(`max_Count-${tableId}`).value || ''
                    };
                }
                ...
                function loadData(page, applyFilters = false) {
                    ...
                    fetch('table/dataProcessor.php?' + params.toString())
                ...
                function updateExportButtons(tableId) {
                    ...
                    exportButtons.innerHTML = `
                        <a href="table/dataProcessor.php?export=csv&file=${encodeURIComponent(filePath)}" class="btn btn-primary">Download CSV</a>
                        <a href="table/dataProcessor.php?export=txt&file=${encodeURIComponent(filePath)}" class="btn btn-primary">Download Text</a>
                        <a href="table/dataProcessor.php?export=xls&file=${encodeURIComponent(filePath)}" class="btn btn-primary">Download Excel</a>
                    `;
                }
