...
<script type="text/javascript">
    ...
    var checkInput = function() {  // 检查后缀名 txt csv excel
        ...
        var confidence = document.getElementById("fc").value;
        if (confidence == ""){
            window.alert("Please input log2(FC)!");
            var draw_form = document.getElementsByClassName("draw_form")[0];
            draw_form.focus();
            return false;
        }

        var confidence = document.getElementById("padj").value;
        if (confidence == ""){
            window.alert("Please input padj!");
            var draw_form = document.getElementsByClassName("draw_form")[0];
            draw_form.focus();
            return false;
        }
    ...
    var download_example_1 = function() {
        const fileUrl = "./example/read_count.txt"; // 文件的实际路径
        const fileName = "read_count.txt"; // 下载时保存的文件名
    ...
    var download_example_2 = function() {
        const fileUrl = "./example/group_info.txt"; // 文件的实际路径
    ...
    var Add_show = function(){
        ...
        document.getElementById("termNum_div").style.display="none";
    }
    var Add_termNum = function(){
        document.getElementById("show_div").style.display="none";
        document.getElementById("termNum_div").style.display="";
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Analysis Flow</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">Analysis Flow</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="all_analysis2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            
            <div class="pb-3" style="margin-bottom: 20px;">
                <label>1. Select data type</label>
                <select class="param_select" id="type" name="type" onChange="change()"> <!-- style="font-size:17px; font-style:italic; -->
            ...
            <div class="pb-3" style="margin-bottom: 0px;">
                <label>2. Upload expression data file</label>
                <input type="file" id="upload_file_1" name="upload_file_1" class="form-control example" data-text="Choose your file">
                <button type="button" class="btn btn-primary example" onclick="download_example_1()">Example</button>
            </div>

            <div class="pb-3" style="margin-bottom: 0px;">
                <label>3. Upload sample information</label>
            ...
            <div class="pb-3" style="margin-bottom: 22px;">
                <label>4. The organism of the input data</label> <br>
            ...
            <!-- 一审 新增-->
            <div class="pb-3" style="margin-bottom: 22px;">
                <label>5. The hypothesis correction method</label> <br>
            ...
            <div class="pb-3" style="margin-bottom: 20px;">
                <!-- 一审 -->
                <label style="margin-bottom: 16px;">6. Input threshold for screening differential genes</label>  &nbsp;&nbsp;&nbsp; <br/>
                <label>log2(FC) threshold (NOTE: |log2FC| > threshold. It is generally 0.58, 1 or 2 obtained from 10.1073/pnas.0502674102 and 10.5194/aab-52-65-2009)</label>  &nbsp;&nbsp;&nbsp;
                <input  type="text" name="fc" id="fc" value="1" class="form-control">
                <label>padj threshold (NOTE: padj < threshold. It is generally 0.05 obtained from 10.5194/aab-52-65-2009)</label>  &nbsp;&nbsp;&nbsp;
