...
<script type="text/javascript">
    ...
    var download_example = function() {
        const fileUrl = "./example/draw_example/venn_example.txt"; // 文件的实际路径
        const fileName = "venn_example.txt"; // 下载时保存的文件名
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Venn Plot</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">Venn Plot</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="draw_venn2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3" style="margin-bottom: 20px; margin-top: 20px;">
                <label>2. Choose plot type</label>  &nbsp;&nbsp;&nbsp;
                <input type="radio" name="plot" value="Venn" checked> Classic venn plot &nbsp;
                <input type="radio" name="plot" value="Vennpie"> Vennpie plot &nbsp;
                <input type="radio" name="plot" value="Barplot"> Bar plot &nbsp;
            ...
            <div class="pb-3" style="text-align: center; margin-top: 30px;">
                ...
                <img src="images/venn_example.png" alt="img" style="margin: 0 auto; width: 900px; height: 250px;">
            </div>
        </form>
