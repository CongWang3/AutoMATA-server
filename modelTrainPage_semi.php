...
<script type="text/javascript">
    ...
    var download_example = function() {
        ...
        const fileUrl = "./example/train_semi_supervised_example.zip"; // 文件的实际路径
        const fileName = "train_semi_supervised_example.zip"; // 下载时保存的文件名
    ...
    function change(v){
        if(v==0){
            document.getElementById("loss_type_ladder").style.display="";
            document.getElementById("gamma_div").style.display="";
            document.getElementById("Reconstruction_loss").style.display="";

            document.getElementById("loss_type_pseudo").style.display="none";
            // document.getElementById("super_loss").style.display="none";
            document.getElementById("pseudo_loss").style.display="none";
            document.getElementById("pseudo_conf").style.display="none";
            document.getElementById("pseudo_ratio_div").style.display="none";
        }else if(v==1){
            document.getElementById("loss_type_ladder").style.display="none";
            document.getElementById("gamma_div").style.display="none";
            document.getElementById("Reconstruction_loss").style.display="none";

            document.getElementById("loss_type_pseudo").style.display="";
            // document.getElementById("super_loss").style.display="";
            document.getElementById("pseudo_loss").style.display="";
            document.getElementById("pseudo_conf").style.display="";
            document.getElementById("pseudo_ratio_div").style.display="";
        }
    }
</script>
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Train your semi-supervised model</span></h2>
...
<section id="service" class="padding-medium">
    ...
    <div class="container">
        ...
        <form id="form" class="train_form" name="train_form" method="post" action="modelTrain_semi.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            
            <!-- <div class="pb-3">
                <label>1. Upload training set (NOTE: The categorized labels of unlabeled samples are marked as Unknown)</label>
            ...
            <div class="pb-3" id="upload_val" style="margin-bottom: 22px; display: ;" >
                <label>Upload validation set (NOTE: All samples must be labeled)</label>
            ...
            <div class="pb-3" style="margin-bottom: 22px;">
                <label>3. Upload testing set (NOTE: All samples must be labeled)</label>
            ...
            <div class="pb-3 upload_dataset" style="margin-bottom: -15px;">
                <label>Upload training set (NOTE: The categorized labels of unlabeled samples are marked as Unknown)</label>  <!-- 一审-->
                <input type="file" id="upload_file_1" name="upload_file_1" class="form-control example" data-text="Choose your file">
                <button type="button" class="btn btn-primary example" onclick="download_example()">Example</button>
            </div>
            ...
            <div class="pb-3 split_dataset" style="margin-bottom: -18px; display: none;">
                <label>Upload a dataset (NOTE: The categorized labels of unlabeled samples are marked as Unknown)</label>
            ...
            <div class="pb-3 kfold_dataset" style="margin-bottom: -18px; display: none;">
                <label>Upload training set (NOTE: The categorized labels of unlabeled samples are marked as Unknown)</label>
            ...
            <div class="pb-3" style="margin-bottom: 22px;">
                ...
                <select class="param_select" id="first" name="model_type" onChange="change(this.value)"> <!-- style="font-size:17px; font-style:italic; -->
                    <option selected="selected" value="0">LadderNetwork > Utilizing unlabeled data through an encoder-decoder architecture</option>
                    <option value="1">Pseudo-Labeling > Iteratively add labels to high-confidence unlabeled data</option>
                </select>
            </div>
            ...
            <div class="pb-3">
                ...
                <select class="param_select" id="loss_type_ladder" name="loss_type_ladder"> <!-- style="font-size:17px; font-style:italic; -->
                    <option selected="selected" value="0">Semi-Supervised Loss</option>
                    <option value="1">Focal Loss</option>
                    <option value="2">Label Smoothing Loss</option>
            ...
            <div class="pb-3" style="display: none;">
                <label>(6) Loss Function</label> -->
                <select class="param_select" id="loss_type_pseudo" name="loss_type_pseudo" style="display: none;"> <!-- style="font-size:17px; font-style:italic; -->
                    <option selected="selected" value="0">Pseudo Labeling Loss</option>
                    <option value="1">Focal Loss</option>
                    <option value="2">Label Smoothing Loss</option>
                </select>
            </div>
            ...
            <div class="pb-3">
                <label>(8) Supervision Loss Weight</label>
                <input type="text" name="alpha" id="alpha" value="1.0" class="form-control">
            </div>

            <div class="pb-3" id="Reconstruction_loss">
                <label>(9) Reconstruction Loss Weight</label>
                <input type="text" name="beta" id="beta" value="1.0" class="form-control">
            </div>

            <div class="pb-3" id="gamma_div" style="margin-bottom: 22px;">
                <label>(10) Regularization Loss Weight</label>
                <input type="text" name="gamma" id="gamma" value="0.1" class="form-control">
            </div>

            <div class="pb-3" style="display: none;" id="pseudo_loss">
                <label>(9) Pseudo-label loss weight</label>
                <input type="text" name="pseudo_beta" id="pseudo_beta" value="0.5" class="form-control">
            </div>

            <div class="pb-3" style="display: none;" id="pseudo_conf">
                <label>(10) Pseudo-label confidence threshold</label>
                <input type="text" name="threshold" id="threshold" value="0.8" class="form-control">
            </div>

            <div class="pb-3" style="display: none; margin-bottom: 22px;" id="pseudo_ratio_div">
                <label>(11) Pseudo-label ratio</label>
                <input type="text" name="pseudo_ratio" id="pseudo_ratio" value="0.5" class="form-control">
            </div>
