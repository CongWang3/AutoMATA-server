...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Dumbbell Plot</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">Dumbbell Plot</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="draw_dumbbell2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3">
                <label>2. Input the label for the x-axis</label>
            ...
            <div class="pb-3" style="margin-bottom: 20px; margin-top: 20px;">
                <label>3. Input terms that you want to emphasize (NOTE: Please separate them by English comma, and entered terms should be included in the uploaded data set) </label>  &nbsp;&nbsp;&nbsp;
            ...
            <div class="pb-3" style="text-align: center; margin-top: 30px;">
                ...
                <img src="images/dumbbell_example.png" alt="img" style="margin: 0 auto; width: 750px; height: 1200px;">
            </div>
        </form>
