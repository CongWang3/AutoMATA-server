...
<script type="text/javascript">
    ...
    var download_example = function() {
        const fileUrl = "./example/test_geneid_fpkm2TPM.txt"; // 文件的实际路径
        const fileName = "geneid_fpkm2TPM_example.txt"; // 下载时保存的文件名
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Genome</span></h2>
            <!-- <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">Genome</span>
            </nav> -->
            <nav class="breadcrumb" style="margin-top: -8px;">  <!--一审-->
             ...
             <!--一审-->
            <nav class="breadcrumb"> 
                <span class="breadcrumb-item active" aria-current="page" style="font-size: 14px; margin-top: -13px;">>Details: This page provide conversion of gene expression data from <i>Homo Sapiens</i>, <i>Bos Taurus</i>, <i>Mus Musculus</i>, <i>Drosophila Melanogaster</i> and <i>Arabidopsis Thaliana</i> in RPKM, TPM, ReadCounts, FPKM and RPM formats to log2(TPM+1) format.
            Users can select different gene nomenclatures as GeneID, EnsemblID and Symbol, and the generated result file provides the Symbol data of the genes corresponding to different nomenclatures. Click "Example" button to download the example data of human gene expression.</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    ...
    <div class="container">
        <form id="form" class="process_form" name="process_form" method="post" action="dataProcess.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            <div class="pb-3">
                <label>1. Upload gene expression data</label>
            ...
            <div class="pb-3" style="margin-bottom: 22px;">
                ...
                <select class="param_select" id="first" name="geneMomen" onChange="change()"> <!-- style="font-size:17px; font-style:italic; -->
                    <option selected="selected" value="0">Gene ID</option>
                    <option value="1">Ensembl ID</option>
                    <option value="2">Gene Symbol</option>
                </select>
            ...
            <div class="pb-3" style="margin-bottom: 22px;">
                ...
                <select class="param_select" id="first" name="organism" onChange="change()"> <!-- style="font-size:17px; font-style:italic; -->
                    ...
                    <!-- <option value="4">Arabidopsis thaliana</option> -->
                </select>
