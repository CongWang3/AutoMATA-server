...
<script type="text/javascript">
    ...
    var download_example = function() {
        const fileUrl = "./example/draw_example/pca_example.txt"; // 文件的实际路径
        const fileName = "pca_example.txt"; // 下载时保存的文件名
    ...
    function usePermanova(){
        document.getElementById("permanovaMethod").style.display="";
    }
    function noUsePermanova(){
        document.getElementById("permanovaMethod").style.display="none";
    }
</script>
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">PCA</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">PCA</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="draw_PCA2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3">
                <label>2. Confidence level</label>
                <input type="text" name="confidence" id="confidence" value="0.95" class="form-control">
            </div>
            <div class="pb-3" style="margin-bottom: 20px; margin-top: 20px;">
                <label>3. Boundary plot</label>  &nbsp;&nbsp;&nbsp;
                <input type="radio" name="boundary" value=TRUE checked> Add boundary plot &nbsp;
                <input type="radio" name="boundary" value=FALSE> Don't add boundary plot

            </div>
            <div class="pb-3" style="margin-bottom: 15px;">
                <label>4. PERMANOVA analysis</label>  &nbsp;&nbsp;&nbsp;
                <input type="radio" name="permanova" value=TRUE onclick="usePermanova();"> Conduct PERMANOVA analysis &nbsp;
                <input type="radio" name="permanova" value=FALSE checked onclick="noUsePermanova();"> Don't conduct PERMANOVA analysis

            </div>
            
            <div class="pb-3" id="permanovaMethod" style="margin-top: -15px; margin-bottom: 22px; display:none;" >
                <label>The method used for PERMANOVA analysis</label>
                <select class="param_select" id="first" name="method" onChange="change()"> <!-- style="font-size:17px; font-style:italic; -->
                    <option selected="selected" value="0">Bray</option>
                    ...
                    <option value="7">AltGower</option>
                    <option value="8">Morisita</option>
                    <option value="9">Horn</option>
                    <option value="10">Mountford</option>
                    <option value="11">Raup</option>
                    <option value="12">Binomial</option>
                    <option value="13">Chao</option>
                    <option value="14">Cao</option>
                    <option value="15">Mahalanobis</option>
                    <option value="16">Chisq</option>
                    <option value="17">Chord</option>
                    <option value="18">Hellinger</option>
                    <option value="19">Aitchison</option>
                    <option value="20">Robust.aitchison</option>
                </select>
            </div>
            ...
            <div class="pb-3" style="text-align: center; margin-top: 30px;">
                ...
                <img src="images/pca_example.png" alt="img" style="margin: 0 auto; width: 900px; height: 600px;">
            </div>
        </form>
