...
<script type="text/javascript">
    ...
    var checkInput = function() {  // 检查后缀名 txt csv excel
        ...
        var confidence = document.getElementById("pvalue").value;
        if (confidence == ""){
            window.alert("Please input pvalue!");
            var draw_form = document.getElementsByClassName("draw_form")[0];
            draw_form.focus();
            return false;
        }

        var confidence = document.getElementById("qvalue").value;
        if (confidence == ""){
            window.alert("Please input qvalue!");
            var draw_form = document.getElementsByClassName("draw_form")[0];
            draw_form.focus();
            return false;
        }
        ...
        var confidence = document.getElementById("termNum").value;
        if (confidence == ""){
            window.alert("Please input the number of terms to be displayed!");
            var draw_form = document.getElementsByClassName("draw_form")[0];
            draw_form.focus();
            return false;
        }
    ...
    var download_example = function() {
        const fileUrl = "./example/draw_example/kegg_enrichment_example.txt"; // 文件的实际路径
        const fileName = "kegg_enrichment_example.txt"; // 下载时保存的文件名
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">KEGG Enrichment</span></h2>
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active" aria-current="page">KEGG Enrichment</span>
            </nav>
        </div>
    </div>
</section>
...
<section id="service" class="padding-medium">
    <div class="container">
        <form id="form" class="draw_form" name="draw_form" method="post" action="draw_kegg2.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            ...
            <div class="pb-3" style="margin-bottom: 20px;">
                <label style="margin-bottom: 16px;">3. Input threshold for KEGG enrichment analysis</label>  &nbsp;&nbsp;&nbsp; <br/>
                <label>pvalue (NOTE: The threshold range is [0, 1]) </label>  &nbsp;&nbsp;&nbsp;
                <input  type="text" name="pvalue" id="pvalue" value="0.1" class="form-control">
                <label>qvalue (NOTE: The threshold range is [0, 1]) </label>  &nbsp;&nbsp;&nbsp;
                <input type="text" name="qvalue" id="qvalue" value="0.1" class="form-control">
                
            </div>

            <div class="pb-3" style="margin-bottom: 20px;">
                <label>4. Correction Method</label>
                <select class="param_select" id="correction" name="correction"> <!-- style="font-size:17px; font-style:italic; -->
            ...
            <div class="pb-3" style="margin-bottom: 20px;">
                <label>4. Plot type</label>  &nbsp;&nbsp;&nbsp;
                <input type="radio" name="type" value="bubble" checked>Bubble &nbsp;
                <input type="radio" name="type" value="chord"> Chord &nbsp;
                <input type="radio" name="type" value="cluster"> Cluster &nbsp; 
                               
            </div>


            <div class="pb-3" id="termNum_div" style="margin-bottom: 20px; display:none;" >
                <label>Input the number of terms to be displayed</label>  &nbsp;&nbsp;&nbsp;
                <input type="text" name="termNum" id="termNum" value="5" class="form-control">
            ...
            <div class="pb-3" style="text-align: center; margin-top: 30px;">
                ...
                <img src="images/kegg_example.png" alt="img" style="margin: 0 auto; width: 1100px; height: 300px;">
            </div>
        </form>
