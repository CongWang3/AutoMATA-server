...
<script type="text/javascript">
    ...
    var checkInput = function() {  // 检查后缀名 txt csv excel
        ...
        // 检查多组学数据
        var files = ["upload_pheno", "upload_file_1", "upload_file_2", "upload_file_3"];
    ...
    var download_example_1 = function() {
        const fileUrl = "./example/train_example/jobID_omics_1.txt"; // 文件的实际路径
        const fileName = "omics_1_example.txt"; // 下载时保存的文件名
    ...
    var download_example_2 = function(){
        const fileUrl = "./example/train_example/jobID_omics_2.txt"; // 文件的实际路径
        const fileName = "omics_2_example.txt"; // 下载时保存的文件名  cnn模型
    ...
    var download_example_3 = function(){
        const fileUrl = "./example/train_example/jobID_omics_3.txt"; // 文件的实际路径
        const fileName = "omics_3_example.txt"; // 下载时保存的文件名  cnn模型
    ...
    var download_example = function(){
        const fileUrl = "./example/train_example/jobID_pheno.txt"; // 文件的实际路径
        const fileName = "pheno_example.txt"; // 下载时保存的文件名  pheno数据
...
<section id="banner">
    <div class="container padding-medium-2">
        <div class="hero-content">
            ...
            <h2 class="display-2 fw-semibold">Integration</span></h2>
            <nav class="breadcrumb" style="margin-top: -4px;">
                ...
                <span class="breadcrumb-item active" aria-current="page">Multi-omics Data Integration</span>
            </nav>

            <!--一审-->
            <nav class="breadcrumb"> 
                <span class="breadcrumb-item active" aria-current="page" style="font-size: 14px; margin-top: -13px;">>Details: This page provide multi-omcis data intergration function based on sample name. Missing values were filled with zeros. Click "Example" button to download the example data.
                </span>
            </nav>
        </div>
    </div>
...
<section id="service" class="padding-medium">
    ...
    <div class="container">
        <form id="form" class="process_form" name="process_form" method="post" action="integration.php" onsubmit="JavaScript: return checkInput()" enctype="multipart/form-data"> <!-- onsubmit="javascript:return checkInput()"-->
            <div class="pb-3">
                <label>1. Upload phenotypic data</label>
                <input type="file" id="upload_pheno" name="upload_pheno" class="form-control example" data-text="Choose your file">
                <button type="button" class="btn btn-primary example" onclick="download_example()">Example</button>
            </div>

            <div class="pb-3">
                <label>2. Upload genomic data</label>
            ...
            <div class="pb-3">
                <label>3. Upload transcriptome data</label>
            ...
            <div class="pb-3">
                <label>4. Upload proteome data</label>
                <input type="file" id="upload_file_3" name="upload_file_3" class="form-control example" data-text="Choose your file">
